...
```{r Load Package and Data, results='hide', message=FALSE}
rm(list = ls())
library(iNEXT)
library(ggplot2)
...
```{r RarefactionCombined, fig.width=24, fig.height=12, dpi=600}
g$labels$title = NULL
