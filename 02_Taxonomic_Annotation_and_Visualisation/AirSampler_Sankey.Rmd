...
```{r, warning=FALSE, fig.height=6, fig.width=6, dpi=300}
rm(list = ls())
...
```{r CercozoaSankey,warning=FALSE, fig.height=6, fig.width=6, dpi=300}
...
```{r CombineSankey, warning=FALSE, fig.height=6, fig.width=6, dpi=300}
